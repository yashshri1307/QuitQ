...
public class Product {
	...
	public Product(int productId, Supplier supplier, int supplierId,
	...
	public String toString() {
		return "Product [productId=" + productId + ", supplier=" + supplier + ", supplierId=" + supplierId + ", name="
				+ name + ", categoryId=" + categoryId + ", price=" + price + ", stock=" + stock + ", description="
